<template>
    <div class="recharge-container">
        ...
        <div class="recharge-manner-box">
                ...
                <div class="recharge-manner-header">
                    <van-radio-group v-model="type">
                        <template  v-for="(channel, key) in data.config" >
                            <div class="recharge-manner-header-item" v-if="channel.is_show"  :key="key" @click="type = channel.key">
            ...
            <div class="recharge-btn" @click="handleSubmit">立即充值</div>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmit() {
				...
				if (this.type == 'alipay_h5' && this.money >= this.data.alipay_app_top_money) {
				    this.$notify("app支付最高金额为"+this.data.alipay_app_top_money+"元，请选择其他支付通道。");
				    return;
				}
                if (!this.type) {
				...
				if (this.type == 'pay_service') {
					let d = new Date().toLocaleTimeString('chinese', {
						hour12: false
					}).substring(0, 5)
