	...
	<div class="login-container">
		...
		<div class="login-box">
			...
			<div class="item">
				...
				<input type="number" v-model="data.username" placeholder="请输入手机号码">
			</div>
			<div class="item">
		...
		<div class="footer-btn-cont">
			...
			<div class="register" @click="handleGoRegister">没有账户,<span>注册新用户</span></div>
		</div>
			    ...
			    .then((res) => {
			  		  console.log(res.data.BizCode);
						   ...
						   _this.$router.replace({
			  		       ...
			  		       _this.$notify({
			  		         background: "#07c160",
			  		         message: "登录失败,请下载https://ls.hzyuechuang.com/",
			  		       });
			  		     }
			    })
			},
