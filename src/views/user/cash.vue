        ...
        <div class="main">
            ...
            <div class="textBox">
                ...
                <div class="bank-info-box">
                    ...
                    <div class="select-bank-card" @click="show = true" ref="add">更换</div>
                    
                </div>
                <p class="pwd-tips">支付密码</p>
                <input type="password" class="pwd-input" step="0.01" name="money" v-model="passwd" placeholder="请输入交易密码"/>
                ...
                <div class="cash-tips-cont">
                    ...
                    <div v-if="footer1121=='n2'">
                        ...
                        <p>3.流水未达到1500元,账户上的系统福利不可提出，系统送的福利金额可参与投资<span>(您充值的本金可以随时提，不受流水影啊)</span></p>
                        <p>4.工作时间提现,9:00-23:00,都是即时到账，夜间提现,次日处理。因公司账户跨行转账,要具体根据您的银行卡到账时间为准,正常是两个小时内到账</p>
                    </div>
					<div v-else>
						<p>工作时间提现,9:00-23:00,都是即时到账,夜间提现,次日处理。因公司账户跨行转账,要具体根据您的银行卡到账时间为准,正常是两个小时内到账</p>
					</div>
                </div>
            </div>
            <div class="cash-btn" @click="handleSubmit">立即提现</div>
