		...
		<!-- <div class="register-header"> -->
			...
			<div class="register-box">
				...
				<div class="item">
					...
					<input type="number" v-model="data.mobile" placeholder="请输入手机号码">
				</div>
				<div class="item">
				...
				<div class="item">
					...
					<input type="password" v-model="data.spassword" placeholder="请确认登录密码">
				</div>
				<!-- <div class="item">
				...
				<div class="item">
					...
					<input v-model="data.t_mobile" placeholder="请输入邀请码(选填)">
				</div>
			</div>
			<div class="captcha" id="captcha" v-show="!showCaptcha"></div>
			<div class="register-btn" @click="handleSubmit">注 册</div>
			<div class="login-btn" @click="handleLogin()">已有账号,<span>立即登录</span></div>
