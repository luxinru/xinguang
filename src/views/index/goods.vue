<template>
	...
	<div class="mobile">
        ...
        <div class="goods-content-box">
            ...
            <div class="my-integral-info-box">
                ...
                <div class="integral-info"><span>总积分</span>{{mydata.integral}}</div>
                <div class="address-btn-box">
                    <div class="address-btn" @click="$router.push('/order')">我的订单</div>
                    <div class="address-btn" @click="$router.push('/address')">收货地址</div>
                </div>
            </div>
            <div class="goods_list">
                <div v-for="(item,j) in category_data.category" v-bind:style="{display: j === dh_index ? 'block' : 'none'}" :key="j">
                    <van-row gutter="5" type="flex">
                        <van-col span="12" v-for="(item2,j_num) in item.list" :key="j_num" style="margin-bottom: 10px;">
                            <div class="right_list">
                                <div class="shop_pic" align="center">
                                    <a :href="'/#/goods_details/'+item2.id"><img :src="item2.img" style="width: 30vw;height: 30vw;border-radius: 10px;" alt="" /></a>
                                </div>
                            ...
                            <span>{{item2.next_level_price}}积分</span>
                                    ...
                                    <!--</div>-->
                                    <div class="list-footer" style="   display: flex; flex-direction: column;
    justify-content: space-around;height: 100px;">
                            ...
                            <span @click="add(j,j_num)">+</span>
                                        ...
                                        <div class="dh_btn" @click="category_btn(item2.id,dh_num[j][j_num])">立即兑换</div>
                                    </div>
                                </div>
                            </div>
                        </van-col>
